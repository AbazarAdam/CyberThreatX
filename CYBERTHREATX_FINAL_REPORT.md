# CyberThreatX v1.1: A Modern SOC-in-a-Box Solution
...
Unlike traditional signature-based systems, CyberThreatX includes a lightweight ML scoring layer that:
- Tracks statistical baselines for common alert patterns.
- Applies heuristic anomaly scoring (0.0 to 1.0) to help prioritize high-risk events.
- Scaffolds optional ML dependencies (e.g., Isolation Forest) for future expansion.
...
Integration with AlienVault OTX ensures that indicators of compromise (IOCs) such as suspicious IP addresses are automatically flagged with reputation data, providing analysts with instant context. VirusTotal configuration is present for future expansion.
...
**Author**: Abazar Adam
**Date**: May 2026
**Version**: CyberThreatX v1.1 (Stable)
